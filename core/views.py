...
def index(request):
    ...
    print(posts)
    return render(request, 'index.html', {'my_posts': my_posts, 'user_profile': user_profile, 'posts': feed_list, 'suggestions_username_profile_list':suggestions_username_profile_list[:4]})
